...
**[macOS용 다운로드](https://www.dureai.dev/download/mac/)** &nbsp;·&nbsp; [웹사이트](https://www.dureai.dev/) &nbsp;·&nbsp; [문서](https://docs.dureai.dev/ko/introduction)
...
이름은 농촌에서 힘을 모아 함께 일하던 **두레**에서 왔습니다. 서로 다른 손이 하나의 일을 돕듯, 에이전트들이 함께 일하고 당신이 방향을 잡습니다.
...
이 저장소는 제품 정보와 미디어를 소개하는 Dure의 공식 공개 GitHub 홈입니다. 앱 소스 코드는 아직 공개되지 않았으며, 오픈소스 공개일이나 라이선스도 발표되지 않았습니다.
...
[Dure 다운로드](https://www.dureai.dev/download/mac/) · [문서 읽기](https://docs.dureai.dev/ko/introduction) · [dureai.dev](https://www.dureai.dev/)
