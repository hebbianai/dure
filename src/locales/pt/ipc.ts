export const ipc: Record<string, string> = {
	...
	"ipc.browser.developmentRequired": "Atualize o servidor selecionado e reconecte para usar Browser.",
	"ipc.browser.runtimeRequired": "Baixe o navegador para usar Browser neste servidor.",
