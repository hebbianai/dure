...
**[Télécharger pour macOS](https://www.dureai.dev/download/mac/)** &nbsp;·&nbsp; [Site web](https://www.dureai.dev/) &nbsp;·&nbsp; [Documentation (anglais)](https://docs.dureai.dev/en/introduction)
...
**[▶ Découvrir Dure en 29 secondes](https://www.dureai.dev/#hero-film)** · [Ouvrir le MP4](https://raw.githubusercontent.com/hebbianai/dure/main/public/readme/workspace-tour.mp4)
...
Ce dépôt est la vitrine publique officielle de Dure sur GitHub pour les informations et médias du produit. Le code source de l'application n'est pas public à ce jour. Aucune date de publication open source ni licence n'a été annoncée.
...
[Télécharger Dure](https://www.dureai.dev/download/mac/) · [Lire la documentation](https://docs.dureai.dev/en/introduction) · [dureai.dev](https://www.dureai.dev/)
