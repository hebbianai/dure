...
use hmux_session_protocol::{
    ...
    OperationReceiptReason, PROVIDER_CONVERSATION_CONTINUATION_CAPABILITY,
    PROVIDER_CONVERSATION_IDENTITY_CAPABILITY, Resize, ResizeReceiptState, ScreenSnapshotRequest,
    SessionFence, WORKING_DIRECTORY_PROJECTION_CAPABILITY,
};
use serde::Serialize;
use std::fmt;
