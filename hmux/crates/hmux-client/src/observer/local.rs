...
use hmux_session_protocol::{
    ...
    PROVIDER_CONVERSATION_IDENTITY_CAPABILITY, SCREEN_SNAPSHOT_PROFILE_CAPABILITY,
    SESSION_RETIREMENT_ADMIN_CAPABILITY, WORKING_DIRECTORY_PROJECTION_CAPABILITY,
};
