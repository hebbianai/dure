...
const SUBSCRIBE_CAPABILITY: &str = "agent_conversation.subscribe.v4";
...
mod tests {
    ...
    fn agent_conversation_requests_use_only_public_negotiated_capabilities() {
        ...
        assert_eq!(
            ...
            Some("agent_conversation.read.v4")
        );
        assert_eq!(SUBSCRIBE_CAPABILITY, "agent_conversation.subscribe.v4");
