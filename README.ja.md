...
名前の由来は、農村の人々が力を合わせて働く韓国の伝統、**두레（Dure）**。それぞれの力で、共通の仕事に取り組む。方向を決めるのは、あなたです。
...
このリポジトリは、製品情報とメディアを紹介する Dure の公式公開 GitHub ホームです。アプリのソースコードは現在公開されておらず、オープンソースの公開日やライセンスも発表されていません。
